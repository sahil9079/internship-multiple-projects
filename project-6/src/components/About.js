        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-8">
            <div className="card shadow p-4 border-0 bg-white bg-opacity-75">
              <h4 className="text-dark mb-3">DevOps & Cloud Engineer</h4>
              <p className="text-muted">
                ...
                Focused on automation, container orchestration, and reliable CI/CD on AWS using Docker, Kubernetes, Jenkins, and Terraform.
              </p>
              <p className="text-muted">
                ...
                Built and shipped a 3‑tier app on Kubernetes (Kops) with Dockerized services and rollouts via Deployments, Services, Ingress, and Secrets.
              </p>
              <p className="text-muted">
                ...
                Comfortable with AWS (EC2, S3, ELB, CloudWatch, RDS), Linux, Git, and scripting in Bash/Python for day‑to‑day automation.
              </p>
