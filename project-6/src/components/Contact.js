            ...
            <div className="card contact-card p-4 shadow border-0 bg-dark bg-opacity-75">
              <div className="card-body text-start">
                <p className="contact-info mb-3">
                  ...
                  <a href="mailto:avijitgorai8250@gmail.com">sahilk.x3@gmail.com</a>
                </p>
                <p className="contact-info mb-3">
                  <FaPhoneAlt className="me-2 icon-warning" />
                  <a href="tel:+91 9391934987">+91 9079105795</a>
                </p>
                <p className="contact-info mb-3">
                ...
                <p className="contact-info mb-3">
                  ...
                  <a
                    href="https://www.linkedin.com/in/sahil-khan-4a07532a6/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    linkedin.com/in/sahil-khan-4a07532a6
                  </a>
                </p>
		<p className="contact-info mb-3">
                  <FaGithub className="me-2 icon-warning" />
                  <a
                    href="https://github.com/sahil9079"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    GitHub Repository
